...
- ✅ **46个技能** - 覆盖需求、方案、增长、风控、战略、专家视角全流程（41 核心 + 5 工具）
...
46 个技能看起来很多，但大多数项目只需要走一条主线。以下是三条最常用的路径：
...
**super-pm** 专为产品经理设计，聚焦产品管理全生命周期（需求洞察、方案设计、增长迭代、风控管理、产品策略），共 46 个技能（41 核心 + 5 工具）。**superpowers** 是 Anthropic 官方出品的软件工程师技能包。两者定位不同，互不冲突，可以同时安装使用。
...
- [技能索引](./skills/INDEX.md) - 全部 46 个技能及依赖关系
