/**
 * Super-PM plugin for OpenCode.ai
 *
...
// Simple frontmatter extraction (avoid dependency on external libs for bootstrap)
...
export const SuperPMPlugin = async ({ client, directory }) => {
  ...
  const getBootstrapContent = () => {
    // Try to load start-super-pm skill
...
You have Super-PM - a complete Product Manager Skills Pack.
