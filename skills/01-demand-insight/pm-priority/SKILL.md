...
digraph pm_priority {
    ...
    subgraph cluster_input {
        ...
        "读取确认需求清单" [shape=box];
        "读取需求调研报告" [shape=box];
        "读取市场调研报告" [shape=box, fillcolor="#e8f5e9"];
        "快速模式手动输入" [shape=box, fillcolor="#fff9c4"];
    }

    subgraph cluster_model {
        label="排序模型选择（主 Agent）";
        style=filled;
        fillcolor="#fff3e0";
    ...
    subgraph cluster_subagent {
        label="Subagent 并行预分析（v2.0 核心优化）";
        style=filled;
        fillcolor="#e8f5e9";
        "需求1预分析 Subagent" [shape=box, fillcolor="#a5d6a7"];
        "需求2预分析 Subagent" [shape=box, fillcolor="#a5d6a7"];
        "需求N预分析 Subagent" [shape=box, fillcolor="#a5d6a7"];
    }
    ...
    subgraph cluster_confirm {
        ...
        style=filled;
        fillcolor="#fce4ec";
        "展示预评分结果" [shape=box, fillcolor="#ffccbc"];
        "用户确认/调整" [shape=box];
    }
    ...
    subgraph cluster_output {
        ...
        style=filled;
        fillcolor="#e1f5fe";
        "Subagent 生成报告" [shape=box, fillcolor="#81d4fa"];
    ...
    "RICE评分" -> "需求1预分析 Subagent" [label="并行派发"];
    "RICE评分" -> "需求2预分析 Subagent" [label="并行派发"];
    "RICE评分" -> "需求N预分析 Subagent" [label="并行派发"];
    "KANO模型" -> "需求1预分析 Subagent" [label="并行派发"];
    "KANO模型" -> "需求2预分析 Subagent" [label="并行派发"];
    "KANO模型" -> "需求N预分析 Subagent" [label="并行派发"];
    "MoSCoW法则" -> "需求1预分析 Subagent" [label="并行派发"];
    "MoSCoW法则" -> "需求1预分析 Subagent" -> "需求2预分析 Subagent";
    "MoSCoW法则" -> "需求N预分析 Subagent";
    "自定义权重" -> "需求1预分析 Subagent";
    "自定义权重" -> "需求2预分析 Subagent";
    "自定义权重" -> "需求N预分析 Subagent";
    
    "需求1预分析 Subagent" -> "展示预评分结果" [label="汇总"];
    "需求2预分析 Subagent" -> "展示预评分结果" [label="汇总"];
    "需求N预分析 Subagent" -> "展示预评分结果" [label="汇总"];
    "展示预评分结果" -> "用户确认/调整";
    "用户确认/调整" -> "Subagent 生成报告";
    "Subagent 生成报告" -> "P0/P1/P2/P3分组";
}
```
