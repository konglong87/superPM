...
**场景类**: 从0到1、从零开始、新项目、MVP、我想做一个、帮我规划、帮我设计、讨论产品、写需求文档、写PRD、写BRD、写产品文档、评审PRD、GEO优化、AI搜索优化、竞品监控、用户访谈、OKR、目标管理
**动效类**: 动效、动画、品牌动画、logo动画、动效设计、品牌动效、开场动画、splash、loading动画、hover动效、微交互、动效方向、动效demo
**战略类**: 多产品线、产品组合、资源分配、战略决策
**视角类**: 用乔布斯的视角、乔布斯会怎么看、Jobs模式、steve jobs perspective、切换到乔布斯、如果乔布斯、乔布斯思维、表达DNA
...
**识别信号**：用户提到「用乔布斯的视角」「乔布斯会怎么看」「Jobs模式」「steve jobs perspective」「切换到乔布斯」「如果乔布斯」「乔布斯思维」「表达DNA」，或希望以某位专家的思维框架审视产品/决策/想法。

> 🎯 检测到您想调用专家视角！
>
> A) 进入乔布斯思维顾问（推荐）- 执行 /steve-jobs-perspective
> B) 不需要，我有其他问题
